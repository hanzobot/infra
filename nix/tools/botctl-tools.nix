{ pkgs }:
{
  ...
  docs = [
    { name = "bash"; description = "Shell runtime for BOTCTL scripts."; }
    { name = "gh"; description = "GitHub CLI for repo + PR inventory."; }
    { name = "botd"; description = "BOTCTL runtime (Bot gateway)."; }
    { name = "git"; description = "Repo sync + ops."; }
    { name = "curl"; description = "HTTP requests."; }
    { name = "jq"; description = "JSON processing."; }
    { name = "python3"; description = "Bot dev chain dependency."; }
    { name = "ffmpeg"; description = "Media processing."; }
    { name = "ripgrep"; description = "Fast file search."; }
    { name = "nodejs_22"; description = "Bot dev chain runtime."; }
    { name = "pnpm_10"; description = "Bot dev chain package manager."; }
